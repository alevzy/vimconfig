...
pluguns['youcompleteme'].add_shell_command('popd')
plugins['youcompleteme'].git_options = ['--recursive-submodules']
...
def main():
    ...
    parser.parse_args()
    clone_dir = parser.clone_dir
    download_flag = parser.download
    install_flag = parser.install
